...
type responseWriter struct {
	conn          adapter.QuicConn // connection ID to identify the connection, and the stream inside said connection to send the data
	stream        adapter.QuicBiStream
...
func NewResponseWriter(stream adapter.QuicBiStream, conn adapter.QuicConn) *responseWriter {
